namespace Ads.Business.Constants
{
	public static class Messages
	{
		...
		public static string MailUpdated = "Mail Adresi Güncellendi";
		public static string SuccessResetPassword = "Şifre Yenileme Linki E-mail Adresinize Gönderilmiştir.";
		public static string AccountApproved = "Hesabınız Onaylandı Giriş Yapabilirsiniz";
		public static string CheckTokenOrMailAdress = "Hesap Bilgilerinizi Veya Token Bilgilerinizi Kontrol Edin!";
